...
export default function Denver() {
  const [buttonText, setButtonText] = useState("Become a Speaker");

  const handleMouseEnter = () => setButtonText("Applications closed");

  const handleMouseLeave = () => setButtonText("Become a Speaker");
  return (
    <>
      <div className="grid lg:grid-cols-2 gap-5 md:gap-20 w-[90%] md:w-[97%] 2xl:w-[80%] mx-auto pt-5 pb-5 lg:pb-0 lg:pt-16 ">
        ...
        <div className="self-center">
          ...
          <div className="flex md:justify-center lg:hidden gap-5 mt-5 md:mt-10">
            <button
              id="btn"
              className="text  font-ubuntu font-[400] text-white text-[15px] md:text-[18px] border-[1px] border-white transition duration-500 ease-in-out transform  hover:bg-[#54FF7A] hover:text-white   rounded-[4px] py-4 px-4 md:px-8 w-[50%] md:w-auto   uppercase"
            >
              Become a Speaker
            </button>
          ...
          <div className="flex gap-5 mt-5 xl:mt-10">
            ...
            > */}
              <button
                ...
                className="text  font-ubuntu font-[400] text-white text-[12px] lg:text-[16px] xl:text-[18px] border-[1px] border-white transition duration-500 ease-in-out transform  hover:bg-[#54FF7A] hover:text-white   rounded-[4px] py-4 px-8   uppercase"
              >
                {buttonText}
              </button>
            {/* </Link> */}
