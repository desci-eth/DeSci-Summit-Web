        ...
        <div className="md:flex justify-between">
          <div>
            ...
            >
              <button
                id="btn"
                className="text mt-10 self-center flex justify-center gap-2 font-ubuntu font-[700] text-[#152EA0] text-[15px] md:text-[18px]  transition duration-500 ease-in-out transform  bg-[#54FF7A] hover:text-white   rounded-[4px] py-4 px-4 md:px-8 w-[50%] md:w-auto uppercase"
              >
                REGISTER NOW
                <svg
