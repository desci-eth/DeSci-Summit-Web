  ...
  return (
    <>
      <div className='grid md:grid-cols-3 w-[90%] md:w-[97%] 2xl:w-[80%] mx-auto border-t-[1px] border-[#4FA366] mt-14'>
       ...
       <p className='text font-[400] text-[40px] md:text-[50px] lg:text-[64px] text-white text-center leading-[45px] lg:leading-[60px]'>70+</p> 
       ...
       <p className=' text font-[400] text-[40px] md:text-[50px] lg:text-[64px] text-white text-center leading-[45px] lg:leading-[60px]'>45h+</p> 
