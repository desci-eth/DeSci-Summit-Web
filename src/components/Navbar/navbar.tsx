...
export default function Navbar() {
  ...
  return (
    <>
      <div className="grid grid-cols-2 lg:grid-cols-12 w-[90%] md:w-[97%] 2xl:w-[80%] mx-auto py-5">
        <div className="lg:col-span-2">
          <img src={Logo} alt="" />
        </div>
        <div className="lg:col-span-10 hidden lg:flex justify-end gap-10 ">
          <Link to="/" className="mt-[9.4px] xl:mt-0 xl:self-center">
            <button className="self-center font-syne font-[400] text-[#EFEBFF] text-[12px] xl:text-[18px] 2xl:text-[20px] uppercase">
              Home
            </button>
          </Link>
          ...
          <div className="self-center">
            <button
              ...
              className="self-center flex gap-1 font-syne font-[400] text-[#EFEBFF] text-[12px] xl:text-[18px] 2xl:text-[20px] uppercase"
            >
            ...
            {isOpen && (
              <div className="origin-top-right  absolute  mt-2 w-[150px] rounded-md shadow-md bg-[#1833b0]">
                <div
                  className="pb-1"
                  role="menu"
                ...
                >
                  <div className="relative p-3">
                    <input
                      type="text"
                      className="font-syne font-[400] text-[12px] text-white bg-[#152EA0] w-full outline-none px-2 py-[2px]"
                    />
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      fill="none"
                      ...
                      strokeWidth={1.5}
                      stroke="currentColor"
                      className="w-3 h-3 text-white absolute right-4 top-5"
                    >
                      <path
                        strokeLinecap="round"
                        strokeLinejoin="round"
      ...
      <Link
          ...
          <Link
            ...
            className="self-center"
          >
            <button className="text self-center flex gap-2 font-ubuntu font-[400] text-[#54FF7A] text-[12px] xl:text-[18px] 2xl:text-[20px] border-[1px] border-[#54FF7A] transition duration-500 ease-in-out transform  hover:bg-[#54FF7A] hover:text-white   rounded-[4px] py-3 px-4 uppercase">
              REGISTER NOW
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
