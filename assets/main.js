...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('.image.style1', { style: 'tilt-left', speed: 1000, intensity: 10, delay: 0, staggerOrder: '', state: true, replay: false });
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'fade-left', speed: 500, intensity: 1, delay: 0, staggerOrder: '', state: true, replay: false });
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'fade-right', speed: 500, intensity: 1, delay: 0, staggerOrder: '', state: true, replay: false });
		onvisible.add('h1.style3, h2.style3, h3.style3, p.style3', { style: 'fade-right', speed: 500, intensity: 1, delay: 0, staggerOrder: '', state: true, replay: false });
		onvisible.add('hr.style1', { style: 'fade-in', speed: 1000, intensity: 5, delay: 0, staggerOrder: '', state: true, replay: false });
		onvisible.add('.buttons.style1', { style: 'zoom-in', speed: 500, intensity: 1, delay: 625, stagger: 125, state: true, replay: false });
		onvisible.add('h1.style5, h2.style5, h3.style5, p.style5', { style: 'fade-right', speed: 500, intensity: 1, delay: 0, staggerOrder: '', state: true, replay: false });
		onvisible.add('.icons.style1', { style: 'fade-down', speed: 500, intensity: 2, delay: 0, stagger: 125, state: true, replay: false });
